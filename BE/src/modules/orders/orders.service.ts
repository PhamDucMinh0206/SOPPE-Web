...
export class OrdersService {
  ...
  async findAll(findProductsDto: FindOrderDto, userId: string = null) {
    ...
    try {
      ...
      //lấy đường dẫn chính xác của ảnh, trong database chỉ lưu key của ảnh
      //từ key ấy sẽ gửi lên aws để lấy đường dẫn chính xác của ảnh và ảnh sẽ đc lưu trên S3
